    ...
    return Scaffold(
      bottomNavigationBar: ConvexAppBar(
        ...
        items: [
          ...
          TabItem(
              icon:Iconify(doctorIcon,color: Colors.white,) ,
              activeIcon: Iconify(doctorIconFill,color: Color(0xff86E3EF),)),
          TabItem(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 120.h,
                    child: Padding(
                      padding: EdgeInsets.only(left: 12.0.w, top: 12.h,right: 12.0.w),
                      child: Column(
                        ...
                        children: [
                          ...
                          FilledButton(
                            ...
                            style: ButtonStyle(fixedSize: WidgetStatePropertyAll(Size(1.sw,30.h)),shape: WidgetStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
